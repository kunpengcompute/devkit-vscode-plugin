...
其中可能包含来自第三方的软件。上述来自第三方的软件均按照“如是”标准提供，我们对这些软件不承担任何责任。',
    ...
    plugins_tuning_message_installingInfo: '请按照终端中的提示操作完成性能分析工具部署',
    plugins_tuning_message_uninstallingInfo: '请按照终端中的提示操作完成性能分析工具卸载',
    plugins_tuning_message_upgradingInfo: '请按照终端中的提示操作完成性能分析工具升级',
    ...
    plugins_tuning_message_install_failed: '请参考{0}官网{1}文档中的可能失败原因进行处理',
