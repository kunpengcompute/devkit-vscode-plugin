...
export class UtilsService {
          ...
          || this.diskMessage.alarmStatus === AlarmStatus.WorkYellowAlarm) {
            ...
            if (workRemain < thresholdValue) {
                this.diskMessage.content = this.i18nService.I18nReplace(
                    this.i18n.plugins_porting_message.workWarn, { 0: workTotal, 1: workRemain, 2: workRecommand });
            } else {
                this.diskMessage.content = this.i18nService.I18nReplace(
                    this.i18n.plugins_porting_message.workInfo, { 0: workTotal, 1: workRemain, 2: workRecommand });
            }
        ...
        if (this.diskMessage.alarmStatus === AlarmStatus.DiskRedAlarm
          || this.diskMessage.alarmStatus === AlarmStatus.DiskYellowAlarm) {
            ...
            if (diskRemain < thresholdValue) {
                this.diskMessage.content = this.i18nService.I18nReplace(
                    this.i18n.plugins_porting_message.diskWarn, { 0: diskTotal, 1: diskRemain, 2: diskRecommand });
            } else {
                this.diskMessage.content = this.i18nService.I18nReplace(
                    this.i18n.plugins_porting_message.diskInfo, { 0: diskTotal, 1: diskRemain, 2: diskRecommand });
            }
            const message = { cmd: 'showDiskMessage', data: this.diskMessage };
            this.vscodeService.postMessage(message, null);
        }
    ...
    public sendDiskAlertMessage() {
        const message = { cmd: 'showDiskAlertMessage', data: this.i18n.plugins_porting_message.workDiskError };
        this.vscodeService.postMessage(message, null);
    }
