...
export class UserManagementComponent implements OnInit {
  ...
  constructor(public timessage: TiMessageService,  private elementRef: ElementRef, public Axios: AxiosService,
              public mytip: MytipService, public i18nService: I18nService, ) {
  ...
  ngOnInit() {
    ...
    this.editRole = new FormGroup({
      ...
      name: new FormControl('', [
        CustomValidators.username(this.i18n),
      ]),
    });
    ...
    this.Axios.axios
      .get(
        '/users/?page=' +
          ...
          '&per-page=' +
          pageSize +
          '&include-admin=false', {headers: { showLoading: false }}
      )
      .then((data: any) => {
  ...
  public doUserOpt(): any {
    ...
    this.Axios.axios[method](url, params)
      .then((data: any) => {
        this.loginPwd = '';
        this.editPwd.reset();
        this.editRole.reset();
...
export class CustomValidators {
  ...
  public static password(i18n: any, editRole: any): ValidatorFn {
    ...
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      if (!reg.test(control.value) || (/[\u4E00-\u9FA5]/i.test(control.value)) || (/[\u3002\uff1f\uff01\uff0c\u3001\uff1b\uff1a\u201c\u201d\u2018\u2019\uff08\uff09\u300a\u300b\u3008\u3009\u3010\u3011\u300e\u300f\u300c\u300d\ufe43\ufe44\u3014\u3015\u2026\u2014\uff5e\ufe4f\uffe5]/i).test(control.value)) {
  ...
  public static username(i18n: any): ValidatorFn {
    ...
    return (control: AbstractControl): ValidationErrors | null => {
      if (!control.value) {
        return { pwd: { tiErrorMessage: i18n.validata.name_req } };
      } else if (!reg.test(control.value)) {
        return { pwd: { tiErrorMessage: i18n.validata.name_rule } };
      } else {
        return null;
      }
    };
