...
@Component({
  selector: 'app-threaddump-detail',
  templateUrl: './threaddump-detail.component.html',
  styleUrls: ['./threaddump-detail.component.scss']
})
export class ThreaddumpDetailComponent implements OnInit, AfterViewInit {
  i18n: any;
  ...
  ngOnInit(): void {
    ...
    this.threaddumpName = sessionStorage.getItem('threaddumpReportTitle');
  }
   ...
   */
   public goHome() {
    this.downloadService.downloadItems.report.reportTab = 'threaddump';
