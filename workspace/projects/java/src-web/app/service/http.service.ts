...
export class HttpService {
  ...
  public get(url: string, params?: any, cb?: any, options?: object) {
  ...
  public post(url: string, data?: object, cb?: any, options?: object) {
  ...
  public put(url: string, data?: object, cb?: any, options?: object) {
  ...
  public delete(url: string, params?: any, cb?: any, options?: object) {
    let httpParams = new HttpParams();
    if (params != null) {
      for (const key of Object.keys(params)) {
        if (params[key]) {
