...
export const MemPerfUrl = {
    ...
    runLog: '/run-logs/?analysis-type=memory_diagnostic',
    runlogAnalyzer: '/run-logs/analyzer/?analysis-type=memory_diagnostic',
    runlogCollector: '/run-logs/collector/?analysis-type=memory_diagnostic'
};
