import { Directive, Input, ElementRef, Renderer2,
    AfterViewInit, TemplateRef, EmbeddedViewRef, ApplicationRef } from '@angular/core';
...
export class FlagTooltipDirective implements AfterViewInit {
    ...
    private setContent(content: string | TemplateRef<any>, context?: any) {
        ...
        if (content instanceof TemplateRef) {
            ...
            this.applicationRef.attachView(embeddedView); // 不做此处处理，ng-template中的标签不会解析
