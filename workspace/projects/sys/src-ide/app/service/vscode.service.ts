...
export class VscodeService {
    ...
    messageHandler: { [key: string]: any } = {
         ...
         */
        getLocale(data: any) {
            self.webviewSession.setItem('language', data.data);
        },
    ...
    public static isAdmin(): boolean {
        ...
        if (self.webviewSession.getItem('role') === 'Admin') {
            isSysPerfLogin = true;
        }
...
export function currentTheme(){
    if (document.body.className.includes('vscode-light') || document.body.className.includes('intellij-light')) {
...
export const isLightTheme =
    document.body.className.includes('vscode-light') || document.body.className.includes('intellij-light');
