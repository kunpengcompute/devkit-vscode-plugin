...
export class OomDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.vscodeService.get({
      url: `/memory-analysis/${this.taskId}/get-oom-info/?oomDetail=oom_time_val&nodeId=${this.nodeId}`
    },
    (res: any) => {
  ...
  public getOomBasicDetail(timeVal: string) {
    this.vscodeService.get({
      url: `/memory-analysis/${
        this.taskId}/get-oom-info/?oomDetail=oom_basic_val&nodeId=${this.nodeId}&timeVal=${timeVal}`
    }, (res: any) => {
  ...
  public getOomProcessCalltrace(timeVal: string){
    this.vscodeService.get({
      url: `/memory-analysis/${
        this.taskId}/get-oom-info/?oomDetail=oom_process_calltrace&nodeId=${this.nodeId}&timeVal=${timeVal}`
    }, (res: any) => {
  ...
  public getOomsystemMem(timeVal: string){
    this.vscodeService.get({
      url: `/memory-analysis/${
        this.taskId}/get-oom-info/?oomDetail=oom_system_mem&nodeId=${this.nodeId}&timeVal=${timeVal}`
    }, (res: any) => {
  ...
  public getOomProcessMem(timeVal: string){
    ...
    this.vscodeService.get({
      url: `/memory-analysis/${
        this.taskId}/get-oom-info/?oomDetail=oom_process_mem&nodeId=${this.nodeId}&timeVal=${timeVal}`
    }, (res: any) => {
  ...
  public getOomInfoDetails(timeVal: string){
    this.vscodeService.get({
      url: `/memory-analysis/${this.taskId}/get-oom-info/?oomDetail=oom_detail&nodeId=${this.nodeId}&timeVal=${timeVal}`
    }, (res: any) => {
