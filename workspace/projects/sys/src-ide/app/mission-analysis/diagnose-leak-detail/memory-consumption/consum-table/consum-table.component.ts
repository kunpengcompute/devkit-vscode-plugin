...
export class ConsumTableComponent implements OnInit, OnDestroy {
  ...
  constructor(public i18nService: I18nService, private vscodeService: VscodeService ) {
  ...
  public isSummuryDataNull = false;
  ngOnInit(): void {
  ...
  public getSummury() {
    ...
    this.vscodeService.get({
      url: `/memory-analysis/${this.taskId}/mem-consume-summary/?${Utils.converUrl(params)}`
    }, (resp: any) => {
