...
export class PerfDataComponent implements OnInit {
  ...
  public uuid: any;
  public netNodataTip = { text: '' };
  public diskNodataTip = { text: '' };
  public usage: any = {
    cpuOptions: [],
    cpuSelected: {},
    smoothSelected: [],
  ...
  public getData(el: any) {
    ...
    if (el === 'cpu_usage') {
      ...
      params = {
        deviceDict: encodeURIComponent(JSON.stringify(this.disk.deviceDict)),
      };
      ...
      params = {
        deviceDict: encodeURIComponent(JSON.stringify(this.net.deviceDict)),
      };
    ...
    let url = `/tasks/taskcontrast/dynamic/?`;
  ...
  public getDevData() {
    ...
    let url = `/tasks/taskcontrast/device-list/?`;
    url += Utils.converUrl(params);
    try {
      this.vscodeService.get({ url }, (res: any) => {
        ...
        this.diskNodataTip.text = this.i18n.common_term_nodata_available;
        this.netNodataTip.text = this.i18n.common_term_nodata_available;
        this.initializing = false;
      });
    } catch (error) {
      this.diskNodataTip.text = this.i18n.common_term_task_nodata2;
      this.netNodataTip.text = this.i18n.common_term_task_nodata2;
    }
  }
  /**
   * 处理设备数据
