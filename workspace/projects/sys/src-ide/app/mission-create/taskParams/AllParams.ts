...
class CustomValidators {
     ...
     * 使用正则校验
     */
    public static regValidate(reg, tip): ValidatorFn {
    ...
    /**
     * 参数A的值跟参数B的值有大小关系【比如：采样间隔应当小于或等于采样时长的1/2】
     */
    public static validTheSizeRelationship({ relatedFormControlName, tip, calcExpression }: {
        ...
        return (control: AbstractControl): ValidationErrors | null => {
            if (relatedFormControlName) {
                ...
                if (!thisControl) {
                    ...
                    relatedFormControl = relatedFormControlName.map(formControlName => {
                        ...
                        if (!formControl) {
                            throw new Error(
                                `matchOtherValidator(): ${formControlName} control is not found in parent group`
                            );
                        }
                    ...
                    relatedFormControl.forEach(formControl => {
            ...
            if (!calcExpression([control.value,
                ...(relatedFormControl as any).map(formControl => formControl.value)])) {
    ...
    constructor() {
        ...
        this.allParams = {
            ...
            taskName: { // 任务名称
                ...
                type: 'input',
                customValidators: [
                    CustomValidators.regValidate(new RegExp('[a-zA-Z0-9@#$%^&*()\\[\\]<>._\\-!~+ ]{1,32}$'),
                ...
                list: [
                    {
                        ...
                        label: i18n.common_term_task_crate_path,
            ...
            application: { // 应用
                ...
                iconTip: i18n.mission_create.modeAppNotice
            },
            applicationParams: { // 应用参数
                label: i18n.common_term_task_crate_parameters,
                required: false,
                type: 'textarea',
                iconTip: i18n.mission_create.modeAppParamsNotice
            },
            ...
            */
            ...
            /* 延迟采样时长
              【伪共享分析】自定义了label、value、min、max和tailPrompt
            */
            delayCollectionTime: {
