  ...
  constructor() {
    ...
    this.interfaces = {
      ...
      interval: {
        ...
        interFaceMapping: ({ operate, formControlValue, setValue, params }: any): any => {
          if (operate === 'get') {
      ...
      task_param: {
        type: {
          ...
          interFaceMapping: ({ operate, formControlValue, setValue, params }: any) => {
            ...
            if (operate === 'get') {
              return formControlValue.map((item: any) => listMapping[item]);
            } else if (operate === 'set') {
              return setValue.map((item: any) => listMapping[item]);
            }
          },
        },
      },
