...
import { TaskDetailMode } from 'projects/sys/src-web/app/domain';
    ...
    ngOnInit() {
            ...
            cycleDate: {
                value: !!this.taskInfo.cycle
                    ? (this.taskInfo.cycleStart || '')
                        .replace(/-/g, '/') + '—' + (this.taskInfo.cycleStop || '').replace(/-/g, '/')
        ...
        if (this.taskInfo.nodeConfig.length > 1
            ...
            this.nodeList = this.taskInfo.nodeConfig.map((nodeItem: any) => {
                ...
                return {
                    title: nodeItem.nodeName + this.i18n.common_term_left_parentheses + nodeItem.nodeIp +
                        this.i18n.common_term_right_parentheses,
                    nodeInfo: [{
