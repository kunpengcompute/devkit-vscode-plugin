...
export class MemLeakFuncListComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        ...
        if (changes.updateTree) {
            ...
            this.funcListDisplay = this.funcListFilter(
                this.pid, this.memLeakType, this.isSelf, this.sort, this.searchKeyword);
        }
    }
    ...
    private async initMemLeakCount() {
        const resp: GetMemoryLeakTimes = await this.axiosService.axios.get(
    ...
    private async initMemLeakSize() {
        const resp: GetMemoryLeakSize = await this.axiosService.axios.get(
    ...
    private async initMemAbnormalRelease() {
        const resp: GetMemoryRelease = await this.axiosService.axios.get(
