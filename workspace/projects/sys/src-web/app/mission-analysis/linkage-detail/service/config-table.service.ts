  ...
  constructor(
    ...
    this.configInfo = [
      ...
      },
      {
        ...
        prop: 'CPU_Package',
        table: [[{
          title: this.i18n.sys.cpuType.slice(0, -1),
          key: 'cpu_type',
          type: 'singleData',
        },
        {
          title: this.i18n.sys.coreNum.slice(0, -1),
          key: 'cpu_cores',
          type: 'multipleValues',
        },
        {
      ...
      { // 内存子系统
        ...
        table: [[{
          title: this.i18n.sys.memCap.slice(0, -1)
        ...
        {
          title: this.i18n.sys.nullNum.slice(0, -1),
          key: 'null',
          type: 'singleData',
        }],
        [{
          ...
          type: 'singleData',
          prop: this.i18n.ddr_summury.percent,
        },
        {
          title: 'pswpin/s',
          key: 'pswpin_sec',
      ...
      { // 存储资源配置
        ...
        table: [[{
          title: this.i18n.sys_summary.cpupackage_tabel.raid_group.slice(0, -1),
          key: 'raid_num',
          type: 'singleData',
        },
        {
      ...
      { // 网口配置
        ...
        [{
          title: this.i18n.sys_cof.sum.network_info.numa_core_title,
          key: 'numa_core',
          type: 'multipleObjects',
