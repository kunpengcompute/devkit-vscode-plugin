...
@Component({
  selector: 'app-mission-sliding',
  templateUrl: './mission-sliding.component.html',
  styleUrls: ['./mission-sliding.component.scss']
})
export class MissionSlidingComponent implements OnInit {
