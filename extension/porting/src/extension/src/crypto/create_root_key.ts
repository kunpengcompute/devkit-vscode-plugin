...
const DEFAULT_BYTES = 'c819906c3d40ec2c31e4215d2f53c106ed5c6194e73c8c49793\
...
function createRandomBytes(pwd: string, userPath: string) {
  ...
  sertFilePermission(efilePath, true);
...
function savaSalt(salt: string, userPath: string) {
  ...
  try {
    ...
    sertFilePermission(pFilePath, false);
  }
}
