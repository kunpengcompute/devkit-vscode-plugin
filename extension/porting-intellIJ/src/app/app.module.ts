...
import { LocationStrategy, HashLocationStrategy } from '@angular/common';         // 解决打包后刷新404问题
...
} from './port-setting/certificate-revocation-list/certificate-revocation-list.component';
